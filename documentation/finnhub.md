...
- [Introduction](https://finnhub.io/docs/api/introduction)
- [Authentication](https://finnhub.io/docs/api/authentication)
- [Limits](https://finnhub.io/docs/api/rate-limit)
- [Excel & Google Spreadsheet](https://finnhub.io/docs/api/excel-plugin-google-spreadsheet) New
- Open Source
- [Libraries](https://finnhub.io/docs/api/library)
- [Open Data](https://finnhub.io/docs/api/open-data)
- Websocket
- [Trades](https://finnhub.io/docs/api/websocket-trades) High Usage
- [News](https://finnhub.io/docs/api/websocket-news) Premium
- [Press Releases](https://finnhub.io/docs/api/websocket-press-releases) Premium
- Stock Fundamentals
- [Symbol Lookup](https://finnhub.io/docs/api/symbol-search)
- [Stock Symbols](https://finnhub.io/docs/api/stock-symbols)
- [Market Status](https://finnhub.io/docs/api/market-status) New
- [Market Holiday](https://finnhub.io/docs/api/market-holiday) New
- [Company Profile](https://finnhub.io/docs/api/company-profile) Premium
- [Company Profile 2](https://finnhub.io/docs/api/company-profile2) New
- [Company Executive](https://finnhub.io/docs/api/company-executive) Premium
- [Market News](https://finnhub.io/docs/api/market-news)
- [Company News](https://finnhub.io/docs/api/company-news) High Usage
- [Press Releases](https://finnhub.io/docs/api/press-releases) Premium
- [News Sentiment](https://finnhub.io/docs/api/news-sentiment) Premium
- [Peers](https://finnhub.io/docs/api/company-peers)
- [Basic Financials](https://finnhub.io/docs/api/company-basic-financials) High Usage
- [Ownership](https://finnhub.io/docs/api/ownership) Premium
- [Fund Ownership](https://finnhub.io/docs/api/fund-ownership) Premium
- [Institutional Profile](https://finnhub.io/docs/api/institutional-profile) Premium
- [Institutional Portfolio](https://finnhub.io/docs/api/institutional-portfolio-13f) Premium
- [Institutional Ownership](https://finnhub.io/docs/api/institutional-ownership) Premium
- [Insider Transactions](https://finnhub.io/docs/api/insider-transactions) New
- [Insider Sentiment](https://finnhub.io/docs/api/insider-sentiment) New
- [Financials](https://finnhub.io/docs/api/financials) Premium
- [Financials As Reported](https://finnhub.io/docs/api/financials-reported) New
- [Revenue Breakdown](https://finnhub.io/docs/api/revenue-breakdown) Premium
- [SEC Filings](https://finnhub.io/docs/api/filings) New
- [SEC Sentiment Analysis](https://finnhub.io/docs/api/filings-sentiment) Premium
- [Similarity Index](https://finnhub.io/docs/api/similarity-index) Premium
- [IPO Calendar](https://finnhub.io/docs/api/ipo-calendar) New
- [Dividends](https://finnhub.io/docs/api/stock-dividends) Premium
- [Sector Metrics](https://finnhub.io/docs/api/sector-metrics) Premium
- [Price Metrics](https://finnhub.io/docs/api/price-metrics) Premium
- [Symbol Change](https://finnhub.io/docs/api/symbol-change) Premium
- [ISIN Change](https://finnhub.io/docs/api/isin-change) Premium
- [Historical Market Cap](https://finnhub.io/docs/api/historical-market-cap) Premium
- [Historical Employee](https://finnhub.io/docs/api/historical-employee-count) Premium
- Stock Estimates
- [Recommendation Trends](https://finnhub.io/docs/api/recommendation-trends)
- [Price Target](https://finnhub.io/docs/api/price-target) Premium
- [Upgrade Downgrade](https://finnhub.io/docs/api/upgrade-downgrade) Premium
- [Revenue Estimates](https://finnhub.io/docs/api/company-revenue-estimates) Premium
- [EPS Estimates](https://finnhub.io/docs/api/company-eps-estimates) Premium
- [EBITDA Estimates](https://finnhub.io/docs/api/company-ebitda-estimates) Premium
- [EBIT Estimates](https://finnhub.io/docs/api/company-ebit-estimates) Premium
- [Net Income Estimates](https://finnhub.io/docs/api/company-net-income-estimates) Premium
- [Pretax Income Estimates](https://finnhub.io/docs/api/company-pretax-income-estimates) Premium
- [Gross Income Estimates](https://finnhub.io/docs/api/company-gross-income-estimates) Premium
- [DPS Estimates](https://finnhub.io/docs/api/company-dps-estimates) Premium
- [EPS Surprises](https://finnhub.io/docs/api/company-earnings) High Usage
- [Earnings Calendar](https://finnhub.io/docs/api/earnings-calendar) New
- Stock Price
- [Quote](https://finnhub.io/docs/api/quote) High Usage
- [Candles (OHLCV)](https://finnhub.io/docs/api/stock-candles) Premium
- [Tick/Trade Data](https://finnhub.io/docs/api/stock-tick) Premium
- [Historical NBBO](https://finnhub.io/docs/api/stock-nbbo) Premium
- [Last Bid-Ask](https://finnhub.io/docs/api/stock-bidask) Premium
- [Splits](https://finnhub.io/docs/api/stock-splits) Premium
- [Dividends 2](https://finnhub.io/docs/api/stock-basic-dividends) Premium
- ETFs & Indices
- [Indices Constituents](https://finnhub.io/docs/api/indices-constituents) Premium
- [Historical Constituents](https://finnhub.io/docs/api/indices-historical-constituents) Premium
- [ETFs Profile](https://finnhub.io/docs/api/etfs-profile) Premium
- [ETFs Holdings](https://finnhub.io/docs/api/etfs-holdings) Premium
- [ETFs Sector](https://finnhub.io/docs/api/etfs-sector-exposure) Premium
- [ETFs Country](https://finnhub.io/docs/api/etfs-country-exposure) Premium
- [ETFs Allocation](https://finnhub.io/docs/api/etfs-allocation) Premium
- Mutual Funds
- [Mutual Funds Profile](https://finnhub.io/docs/api/mutual-fund-profile) Premium
- [Mutual Funds Holdings](https://finnhub.io/docs/api/mutual-fund-holdings) Premium
- [Mutual Funds Sector](https://finnhub.io/docs/api/mutual-fund-sector-exposure) Premium
- [Mutual Funds Country](https://finnhub.io/docs/api/mutual-fund-country-exposure) Premium
- [Mutual Funds EET](https://finnhub.io/docs/api/mutual-fund-eet) Premium
- [Mutual Funds EET PAI](https://finnhub.io/docs/api/mutual-fund-eet-pai) Premium
- Bonds
- [Bond Profile](https://finnhub.io/docs/api/bond-profile) Premium
- [Bond Price](https://finnhub.io/docs/api/bond-price) Premium
- [Tick/Trade Data](https://finnhub.io/docs/api/bond-tick) Premium
- [Yield Curve](https://finnhub.io/docs/api/bond-yield-curve) Premium
- Forex
- [Exchanges](https://finnhub.io/docs/api/forex-exchanges)
- [Symbols](https://finnhub.io/docs/api/forex-symbols)
- [Candles](https://finnhub.io/docs/api/forex-candles) Premium
- [All Rates](https://finnhub.io/docs/api/forex-rates) Premium
- Crypto
- [Exchanges](https://finnhub.io/docs/api/crypto-exchanges)
- [Symbols](https://finnhub.io/docs/api/crypto-symbols)
- [Profile](https://finnhub.io/docs/api/crypto-profile) Premium
- [Candles](https://finnhub.io/docs/api/crypto-candles) Premium
- Technical Analysis
- [Pattern Recognition](https://finnhub.io/docs/api/pattern-recognition) Premium
- [Support/Resistance](https://finnhub.io/docs/api/support-resistance) Premium
- [Aggregate Indicators](https://finnhub.io/docs/api/aggregate-indicator) Premium
- [Technical Indicators](https://finnhub.io/docs/api/technical-indicator) Premium
- Alternative Data
- [Transcripts List](https://finnhub.io/docs/api/transcripts-list) Premium
- [Transcripts](https://finnhub.io/docs/api/earnings-call-transcripts-api) Premium
- [Earnings Call Live](https://finnhub.io/docs/api/earnings-call-live-api) Premium
- [Company Presentation](https://finnhub.io/docs/api/stock-presentation-slide-api) Premium
- [Social Sentiment](https://finnhub.io/docs/api/social-sentiment) Premium
- [Investment Themes](https://finnhub.io/docs/api/investment-themes-thematic-investing) Premium
- [Supply Chain](https://finnhub.io/docs/api/supply-chain-relationships) Premium
- [Company ESG](https://finnhub.io/docs/api/company-esg-score-api) Premium
- [Historical ESG](https://finnhub.io/docs/api/company-historical-esg-score-api) Premium
- [Earnings Quality Score](https://finnhub.io/docs/api/company-earnings-quality-score-api) Premium
- [USPTO Patents](https://finnhub.io/docs/api/stock-uspto-patent) New
- [Visa Application](https://finnhub.io/docs/api/stock-visa-application) New
- [Senate Lobbying](https://finnhub.io/docs/api/stock-lobbying) New
- [USA Spending](https://finnhub.io/docs/api/stock-usa-spending) New
- [Congressional Trading](https://finnhub.io/docs/api/congressional-trading) Premium
- [Bank Branch API](https://finnhub.io/docs/api/bank-branch-api) Premium
- [FDA Calendar](https://finnhub.io/docs/api/fda-committee-meeting-calendar)
- Enterprise data
- [AI Copilot](https://finnhub.io/docs/api/ai-copilot-llm) Premium
- [Revenue Breakdown & KPI](https://finnhub.io/docs/api/revenue-breakdown-kpi-api) Premium
- [Newsroom](https://finnhub.io/docs/api/stock-newsroom) Premium
- Global Filings Search
- [International Filings](https://finnhub.io/docs/api/international-filings) Premium
- [Filings Search](https://finnhub.io/docs/api/global-filings-search) Premium
- [Search In Filing](https://finnhub.io/docs/api/search-in-filing) Premium
- [Search Filter](https://finnhub.io/docs/api/global-filings-search-filter) Premium
- [Download Filings](https://finnhub.io/docs/api/global-filings-download) Premium
- Economic
- [Country List](https://finnhub.io/docs/api/country)
- [Economic Calendar](https://finnhub.io/docs/api/economic-calendar) Premium
- [Economic Codes](https://finnhub.io/docs/api/economic-code) Premium
- [Economic](https://finnhub.io/docs/api/economic-data) Premium
...
**Swagger schema**: [Download](https://finnhub.io/static/swagger.json)

## Authentication

All GET request require a token parameter `token=apiKey` in the URL or a header `X-Finnhub-Token : apiKey`. You can find your API Key under [Dashboard](https://finnhub.io/dashboard). If you are logged in, your API key will be automatically used in the examples so you can copy and paste them as is.
...
[Finsheet](https://finsheet.io/) is the official spreadsheet's plugin partner using fundamental data and estimates data from Finnhub. If you are looking to complement the stock price data you already got directly from Excel and Google Sheets with some advanced data, [Finsheet's Excel and Google Sheets plugin](https://finsheet.io/) offer an affordable way to access global fundamentals and estimates right in your spreadsheet.

![](https://finsheet.io/static/img/candles.png)
...
| Datasets | Download |
| --- | --- |
| SEC Financials As Reported | [Kaggle](https://www.kaggle.com/finnhub/reported-financials) |
| SEC Filings Metadata | [Kaggle](https://www.kaggle.com/finnhub/sec-filings) |
| S&P 500 futures tick data | [Kaggle](https://www.kaggle.com/finnhub/sp-500-futures-tick-data-sp) |
...
List of trade conditions. A comprehensive list of trade conditions code can be found [here](https://docs.google.com/spreadsheets/d/1PUxiSWPHSODbaTaoL2Vef6DgU-yFtlRGZf19oBb9Hp0/edit?usp=sharing)

Sample codePythonJavascriptGo
...
Sample codecURLPythonJavascriptGoRubyKotlinPHP
...
List supported stocks. We use the following symbology to identify stocks on Finnhub `Exchange_Ticker.Exchange_Code`. A list of supported exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp=sharing).
...
Exchange you want to get the list of symbols from. List of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1I3pBxjfXB056-g_JYf_6o3Rns3BV2kMGG1nCatb91ls/edit?usp=sharing).
...
Get the holdings/portfolio data of institutional investors from 13-F filings. Limit to 1 year of data at a time. You can get a list of supported CIK [here](https://finnhub.io/api/v1/institutional/list?token=).
...
Transaction code. A list of codes and their meanings can be found [here](https://www.sec.gov/about/forms/form4data.pdf).
...
_Wondering why our standardized data is different from Bloomberg, Reuters, Factset, S&P or Yahoo Finance ? Check out our [FAQ page](https://finnhub.io/faq) to learn more_
...
Get financials as reported. This data is available for bulk download on [Kaggle SEC Financials database](https://www.kaggle.com/finnhub/reported-financials).
...
List company's filing. Limit to 250 documents at a time. This data is available for bulk download on [Kaggle SEC Filings database](https://www.kaggle.com/finnhub/sec-filings).
...
Get sentiment analysis of 10-K and 10-Q filings from SEC. An abnormal increase in the number of positive/negative words in filings can signal a significant change in the company's stock price in the upcoming 4 quarters. We make use of [Loughran and McDonald Sentiment Word Lists](https://sraf.nd.edu/textual-analysis/resources/) to calculate the sentiment for each filing.
...
Region. A list of supported values for this field can be found [here](https://docs.google.com/spreadsheets/d/1afedyv7yWJ-z7pMjaAZK-f6ENY3mI3EBCk95QffpoHw/edit?usp=sharing).
...
Analyst's recommendation trend AAPL

Created with Highcharts 12.6.0\# AnalystsAAPL Recommendation Trends15​1515​1514​1414​1414​1414​1423​2323​2321​2121​2122​2223​2317​1716​1616​1617​1716​1615​152​22​22​22​22​22​20​00​00​00​00​00​0Strong BuyBuyHoldSellStrong SellNov 2025Dec 2025Jan 2026Feb 2026Mar 2026Apr 20260204060
...
Finnhub Stock API - NVDA Chart

Created with Highcharts 12.6.0NVDA Stock Price TargetPast 12 Months with 12 Months Forecast$100$200$300$400$500

May 2025Jun 2025Jul 2025Aug 2025Sep 2025Oct 2025Nov 2025Dec 2025Jan 2026Feb 2026Mar 2026Apr 2026May 2026Jun 2026Jul 2026Aug 2026Sep 2026Oct 2026Nov 2026Dec 2026Jan 2027Feb 2027Mar 2027Apr 2027May 2027

[![Finnhub](https://static.finnhub.io/img/finnhub_2020-05-09_20_51/logo/logo-gradient2.png)By Finnhub](https://finnhub.io/docs/api/etfs-holdings)
...
Historical Earnings Per Share AAPL

Created with Highcharts 12.6.0Quarterly EPS EstimatesAAPL - EPS EstimatesEPS HighEPS AverageEPS Low2026-03-312026-06-302026-09-302026-12-312027-03-312027-06-301234
...
`/stock/net-income-estimate?symbol=AAPL`

`/stock/net-income-estimate?symbol=TSLA&freq=annual`
...
## Pretax Income Estimates Premium
...
`/stock/pretax-income-estimate?symbol=AAPL`

`/stock/pretax-income-estimate?symbol=TSLA&freq=annual`
...
## Gross Income Estimates Premium
...
`/stock/gross-income-estimate?symbol=AAPL`

`/stock/gross-income-estimate?symbol=TSLA&freq=annual`
...
`/stock/dps-estimate?symbol=AAPL`

`/stock/dps-estimate?symbol=MCD&freq=annual`
...
Created with Highcharts 12.6.0Quarterly EPSAAPL - Historical EPS SurprisesActualEstimate2025-03-31​Missed: 0.012025-06-30​Beat: 0.112025-09-30​Beat: 0.042025-12-31​Beat: 0.112026-03-31​Beat: 0.021234
...
Status of the response. This field can either be ok or no\_data.
...
For more historical tick data, you can visit our bulk download page in the Dashboard [here](https://finnhub.io/dashboard/download) to speed up the download process.

| Exchange | Segment | Delay |
| --- | --- | --- |
| US CTA/UTP | Full SIP | End-of-day |
| TSX | - TSX<br>- TSX Venture<br>- Index | End-of-day |
| LSE | - London Stock Exchange (L)<br>- LSE International (L)<br>- LSE European (L) | 15 minute |
| Euronext | - Euronext Paris (PA)<br>- Euronext Amsterdam (AS)<br>- Euronext Lisbon (LS)<br>- Euronext Brussels (BR)<br>- Euronext Oslo (OL)<br>- Euronext London (LN)<br>- Euronext Dublin (IR)<br>- Index<br>- Warrant | End-of-day |
| Deutsche Börse | - Frankfurt (F)<br>- Xetra (DE)<br>- Duesseldorf (DU)<br>- Hamburg (HM)<br>- Berlin (BE)<br>- Hanover (HA)<br>- Stoxx (SX)<br>- TradeGate (TG)<br>- Zertifikate (SC)<br>- Index<br>- Warrant | End-of-day |
...
`/stock/tick?symbol=AAPL&date=2026-04-22&limit=500&skip=0&format=json`

`/stock/tick?symbol=AC.TO&date=2026-04-22&limit=500&skip=0&format=json`

`/stock/tick?symbol=BARC.L&date=2026-04-22&limit=500&skip=0&format=json`
...
List of venues/exchanges. A list of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1Tj53M1svmr-hfEtbk6_NpVR1yAyGLMaH6ByYU6CG0ZY/edit?usp=sharing)
...
For US market, this endpoint only serves historical NBBO from the beginning of 2023. To download more historical data, please visit our bulk download page in the Dashboard [here](https://finnhub.io/dashboard/download).
...
List of venues/exchanges - Ask price. A list of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1Tj53M1svmr-hfEtbk6_NpVR1yAyGLMaH6ByYU6CG0ZY/edit?usp=sharing)
...
List of venues/exchanges - Bid price. A list of exchange codes can be found [here](https://docs.google.com/spreadsheets/d/1Tj53M1svmr-hfEtbk6_NpVR1yAyGLMaH6ByYU6CG0ZY/edit?usp=sharing)

**c**

List of quote conditions. A comprehensive list of quote conditions code can be found [here](https://docs.google.com/spreadsheets/d/1iiA6e7Osdtai0oPMOUzgAIKXCsay89dFDmsegz6OpEg/edit?usp=sharing)
...
print(finnhub_client.stock_basic_dividends('AAPL'))
```
...
Get a list of index's constituents. A list of supported indices for this endpoint can be found [here](https://finnhub.io/api/v1/index/list?token=).
...
Get full history of index's constituents including symbols and dates of joining and leaving the Index. A list of supported indices for this endpoint can be found [here](https://finnhub.io/api/v1/index/historical-list?token=).
...
Get ETF profile information. This endpoint has global coverage. A list of supported ETFs can be found [here](https://finnhub.io/api/v1/etf/list?type=csv&token=).
...
Expense ratio. For non-US funds, this is the [KID ongoing charges](https://www.esma.europa.eu/sites/default/files/library/2015/11/09_1028_final_kid_ongoing_charges_methodology_for_publication_u_2_.pdf).
...
Get full ETF holdings/constituents. This endpoint has global coverage. Widget only shows top 10 holdings. A list of supported ETFs can be found [here](https://finnhub.io/api/v1/etf/list?token=).
...
2026-04-302026-04-292026-04-282026-04-272026-04-242026-04-232026-04-222026-04-212026-04-202026-04-17
...
| Symbol | Holdings | Weight(%) | Market Value($) | Quantity |
| --- | --- | --- | --- | --- |
| NVDA | NVIDIA CORP | 7.84266 | $62,726,919,942.19 | 314,310,367 |
| AAPL | APPLE INC | 6.44246 | $51,527,860,906.95 | 189,894,457 |
| MSFT | MICROSOFT CORP | 4.8969 | $39,166,205,917.54 | 96,047,393 |
| AMZN | AMAZON.COM INC | 4.18742 | $33,491,673,793.96 | 126,355,066 |
| GOOGL | ALPHABET INC CLASS A | 3.62301 | $28,977,411,715.2 | 75,305,124 |
| AVGO | BROADCOM INC | 3.20067 | $25,599,495,014.34 | 61,326,438 |
| GOOG | ALPHABET INC CLASS C | 2.88865 | $23,103,901,984.8 | 60,490,920 |
| META | META PLATFORMS INC CLASS A | 2.16438 | $17,311,089,325.14 | 28,290,254 |
| TSLA | TESLA INC | 1.73575 | $13,882,838,824.35 | 36,377,745 |
| BRK.B | BERKSHIRE HATHAWAY INC CLASS B | 1.40446 | $11,233,114,278.4 | 23,718,569 |

ETF holdings is provided by [Finnhub Stock API](https://finnhub.io/docs/api/etfs-holdings). This page is not an investment advice and does not constitute any offer or solicitation to offer or recommendation of any investment product.

[![](https://static.finnhub.io/img/finnhub_2020-05-09_20_51/logo/logo-gradient2.png)By Finnhub](https://finnhub.io/docs/api/etfs-holdings)
...
## ETFs Equity Allocation Premium
...
Get mutual funds profile information. This endpoint covers both US and global mutual funds. For international funds, you must query the data using ISIN. A list of supported funds can be found [here](https://finnhub.io/api/v1/mutual-fund/list?type=csv&token=).
...
Get full Mutual Funds holdings/constituents. This endpoint covers both US and global mutual funds. For international funds, you must query the data using ISIN. A list of supported funds can be found [here](https://finnhub.io/api/v1/mutual-fund/list?token=).
...
Get general information of a bond. You can query by FIGI, ISIN or CUSIP. A list of supported bonds can be found [here](https://finnhub.io/api/v1/bond/list?type=csv&token=).
...
| International Bonds | International Bonds | End-of-day |
...
List of trade conditions. A comprehensive list of trade conditions code can be found [here](https://docs.google.com/spreadsheets/d/1O3aueXSPOqo7Iuyz4PqDG6yZunHsX8BTefZ2kFk5pz4/edit?usp=sharing)
...
List of values showing the counterparty of each trade. List of supported values: [here](https://docs.google.com/spreadsheets/d/1O3aueXSPOqo7Iuyz4PqDG6yZunHsX8BTefZ2kFk5pz4/edit?usp=sharing)
...
List of values showing the reporting party of each trade. List of supported values: [here](https://docs.google.com/spreadsheets/d/1O3aueXSPOqo7Iuyz4PqDG6yZunHsX8BTefZ2kFk5pz4/edit?usp=sharing)

**si**

List of values showing the side (Buy/sell) of each trade. List of supported values: [here](https://docs.google.com/spreadsheets/d/1O3aueXSPOqo7Iuyz4PqDG6yZunHsX8BTefZ2kFk5pz4/edit?usp=sharing)
...
Bond's code. You can find the list of supported code [here](https://docs.google.com/spreadsheets/d/1iA-lM0Kht7lsQZ7Uu_s6r2i1BbQNUNO9eGkO5-zglHg/edit?usp=sharing).
...
Finnhub Stock API - OANDA:EUR\_USD Chart
...
Finnhub Stock API - BINANCE:BTCUSDT Chart
...
Indicator name. Full list can be found [here](https://docs.google.com/spreadsheets/d/1ylUvKHVYN2E87WdwIza8ROaCpd48ggEl1k5i5SgA29k/edit?usp=sharing).

**indicator\_fields**optional

Check out [this page](https://docs.google.com/spreadsheets/d/1ylUvKHVYN2E87WdwIza8ROaCpd48ggEl1k5i5SgA29k/edit?usp=sharing) to see which indicators and params are supported.
...
print(finnhub_client.earnings_call_live("2024-11-01", "2024-11-30"))
```
...
print(finnhub_client.stock_presentation('IBM'))
```
...
A full list of themes supported can be found [here](https://docs.google.com/spreadsheets/d/1ULj9xDh4iPoQj279M084adZ2_S852ttRthKKJ7madYc/edit?usp=sharing). The theme coverage and portfolios are updated bi-weekly by our analysts. Our approach excludes penny, super-small cap and illiquid stocks.
...
Investment theme. A full list of themes supported can be found [here](https://docs.google.com/spreadsheets/d/1ULj9xDh4iPoQj279M084adZ2_S852ttRthKKJ7madYc/edit?usp=sharing).
...
SOC Code. A list of SOC code can be found [here](https://www.bls.gov/oes/current/oes_stru.htm).
...
For historical data, you can download it here: [Pre-2021](https://finnhub.io/api/v1/stock/usa-spending?fileId=before_2021&token=), [2021](https://finnhub.io/api/v1/stock/usa-spending?fileId=2021&token=), [2022](https://finnhub.io/api/v1/stock/usa-spending?fileId=2022&token=), [2023](https://finnhub.io/api/v1/stock/usa-spending?fileId=2023&token=), [2024](https://finnhub.io/api/v1/stock/usa-spending?fileId=2024&token=)
...
Sample codecURLPythonJavascript
...
url = "https://finnhub.io/api/v1/global-filings/download?documentId=AAPL_1113753&token="
